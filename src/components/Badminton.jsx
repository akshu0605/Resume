                    ...
                    <div className="space-y-12 lg:space-y-24">
                        {timeline.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="flex-shrink-0">
                                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${index % 2 === 0 ? 'from-primary to-primary/50' : 'from-secondary to-secondary/50'
                                    ...
                                    <div className={`inline-block bg-gradient-to-r ${index % 2 === 0 ? 'from-primary/20 to-primary/5' : 'from-secondary/20 to-secondary/5'
                                        } px-4 py-2 rounded-lg border ${index % 2 === 0 ? 'border-primary/30' : 'border-secondary/30'
                                        }`}>
                                ...
                                >
                                    <div className={`w-8 h-8 rounded-full bg-gradient-to-br ${index % 2 === 0 ? 'from-primary to-primary/50' : 'from-secondary to-secondary/50'
